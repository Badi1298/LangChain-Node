const { Frequencies, RedemptionTypes } = require("../../config/constants.js");
...
const calculateCouponLevel = (couponLevel, denomination) => {
	return +formatNumber((100 * parseFloat(couponLevel)) / parseFloat(denomination));
};

const computeRedemptionType = (redemptionType) => {
	if (redemptionType.toLowerCase() === "cash settlement or delivery of underlying") {
