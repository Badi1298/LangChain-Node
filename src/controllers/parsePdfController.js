		...
		try {
			...
			const response = await openaiInstance.chat.completions.create({
				...
				messages: [
					{
						role: "system",
						content: `You are an expert financial analyst. Your task is to extract information from the provided document text and return *only* a single, valid JSON object. Do not add any explanatory text. Use null if a value cannot be found. All dates must be in dd.mm.yyyy format.`,
					},
					{
						role: "user",
						content: `
