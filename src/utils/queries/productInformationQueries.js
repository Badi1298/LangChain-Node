module.exports = {
	9: [
		...
		"What is the Issue Price and Issue Size inside the Product Details section? If the issue price is given as a percentage, return 1, otherwise return 0 (as numbers). Only return the NUMBER 1 or 0 based on the specifications just described.",
