...
const userPromptTemplate = ({
	...
	const promptText = `
        ...
        Provide a brief explanation (1-2 sentences maximum per stock) suggesting potential reasons why this stock's current volatility is in the lower part of its recent historical (52-week) range, despite being in a similar business area as the selected stocks (${selectedInfo}).
        ...
        **Important:** Return only the suggestions, do not give an introduction like "Okay, I will select up to 5 stocks...".
    `;
